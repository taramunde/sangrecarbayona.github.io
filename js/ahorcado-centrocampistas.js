/* js/ahorcado-centrocampistas.js */

// LISTA DE CENTROCAMPISTAS [NOMBRE, PISTA]
var word = [
    ["PUCKO", "Único centrocampista esloveno del Oviedo."],
    ["TONIJUAN", "Centrocampista pero como entrenador se consiguió el primer ascenso a 1ª de la historia."],
    ["SANSON", "Nombre mitológico para un centrocampista gallego."],
    ["PELAYO", "Tuvo que retirarse del fútbol por problemas médicos."],
    ["PROSINECKI", "Conocido como el croata de cristal."],
    ...
    ["IRIARTE", "Navarro de la década de los 70."],
    ["IDIAKEZ", "Vino procedente de la Real Sociedad en 2002/2003."]
];
