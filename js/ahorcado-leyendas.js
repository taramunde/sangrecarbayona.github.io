...
var word = [
  [
    "MARIANIN",
    "En su primera temporada con el Oviedo, fue máximo goleador de Primera División.",
  ],
  [
    "LANGARA",
    "Es considerado el mejor goleador español de todos los tiempos según la IFFHS.",
  ],
  ["DELY VADES", "Vino procedente del París Saint-Germain F.C."],
  [
    "GORRIARAN",
    "Fue conocido por su fiabilidad y constancia en la línea defensiva.",
  ],
  [
    "HERRERITA",
    "Es recordado por su temperamento fuerte y liderazgo en el campo.",
  ],
  [
    "LINARES",
    "Fue muy querido por la afición y considerado uno de los héroes del barro del club.",
  ],
  ["VITI", "Fue portero del Real Oviedo desde 1979 hasta su retirada en 1994."],
  [
    "SANCHEZ LAGE",
    "Marcó el gol número 800 del Real Oviedo en Primera División en 1960.",
  ],
  [
    "FRED PENTLAND",
    "Era conocido por su característico bombín y fue una figura legendaria en el fútbol español de los años 20 y 30.",
  ],
  [
    "EMILÍN",
    "Destacaba en los saques de esquina, con goles directos que impresionaban a rivales como Real Madrid y Barcelona.",
  ],
  [
    "CARLOS",
    "Es el quinto máximo goleador histórico del Real Oviedo, con 133 goles.",
  ],
  [
    "RIVAS",
    "Su etapa como entrenador coincidió con una etapa de crisis deportiva y económica para el Oviedo, marcada por dos descensos.",
  ],
  [
    "DIEGO CERVERO",
    "Fue pichichi de Tercera División y Segunda B con el equipo.",
  ],
  [
    "MANU BUSTO",
    "Figura emblemática en las temporadas del Oviedo en Segunda B, una época de reconstrucción.",
  ],
];
